...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get(
        '/master-software-edit-software-requirement/{id}',
    ...
    Route::delete(
        '/master-software-delete-software-requirement/{id}',
    ...
    Route::put(
        '/master-software-update-software-requirement/{id}',
    ...
    Route::post(
        '/master-software-store-software-requirement/{id}',
